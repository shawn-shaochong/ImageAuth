...
public class Steganography
{
        ...
        public boolean encode(String file_path,String img_name, String message)
        {
        		String file = file_path+img_name;
                BufferedImage image_orig = getImage(file);
                //System.out.print(image_orig);
                BufferedImage image = user_space(image_orig);
                image = add_text(image,message);
                //System.out.print(image);
                String file_new="encrypted.png";
                String save_path = file_path+file_new;
                return(setImage(image,new File(save_path),"png"));
        }
